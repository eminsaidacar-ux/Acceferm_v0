...
const GLOSSARY: Term[] = [
  ...
  { term: "BUS 2easy (Came)", def: "Protocole filaire 2 fils propriétaire Came. Permet le câblage simple des accessoires (photocellules, claviers) avec polarité libre. Standard sur armoires modernes Came.", related: ["Filaire polarisé"] },
  { term: "BUS-L (Nice)", def: "Équivalent Nice du 2easy. Protocole 2 fils pour accessoires compatibles. Gain de câble et fiabilité accrue.", },
  ...
  { term: "Filaire polarisé", def: "Câblage classique d'accessoires à respecter positif/négatif. Opposé au 2easy / BUS-L qui accepte n'importe quel sens.", related: ["BUS 2easy (Came)"] },
